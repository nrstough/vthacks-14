...
rule it out. That is the same as ticking "Can't do this" on that row, which is the same \
checkbox on every row whether the change is in the plan or in the left-out list. You can also \
offer to put a ruled-out change back, or to move the starting balance or the cushion. It \
touches nothing but what the solver is asked.
